...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - 后台管理</title>
        ...
        <aside class="w-64 bg-gray-900 min-h-screen fixed">
            ...
            <nav class="mt-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                   class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-800 text-white border-r-4 border-sky-500' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.articles.index')); ?>"
                   class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.articles.*') ? 'bg-gray-800 text-white border-r-4 border-sky-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>"
                   class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-gray-800 text-white border-r-4 border-sky-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.tags.index')); ?>"
                   class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition
                          <?php echo e(request()->routeIs('admin.tags.*') ? 'bg-gray-800 text-white border-r-4 border-sky-500' : ''); ?>">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                    </svg>
                    标签管理
            ...
            <div class="absolute bottom-0 w-full p-6 border-t border-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-white text-sm"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-gray-400 text-xs"><?php echo e(auth()->user()->email); ?></p>
                    </div>
