<?php $__env->startSection('title', '标签管理'); ?>

<?php $__env->startSection('content'); ?>
<div class="flex items-center justify-between mb-8">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">标签管理</h1>
        <p class="text-gray-500 mt-1">管理文章标签</p>
    </div>
        ...
        <tbody class="divide-y divide-gray-100">
            <?php $__empty_1 = true; $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($tag->name); ?></td>
                    <td class="px-6 py-4 text-gray-500"><?php echo e($tag->slug); ?></td>
                    <td class="px-6 py-4 text-gray-500"><?php echo e($tag->articles_count); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/tags/index.blade.php ENDPATH**/ ?>