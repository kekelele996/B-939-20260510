...
<div class="mb-8">
    ...
    <p class="text-gray-500 mt-1"><?php echo e($article->title); ?></p>
</div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <textarea id="excerpt"
                          ...
                          placeholder="文章摘要，显示在列表页"><?php echo e(old('excerpt', $article->excerpt)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <textarea id="content"
                          ...
                          placeholder="输入文章内容"><?php echo e(old('content', $article->content)); ?></textarea>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="mb-4">
                    ...
                    <select id="status"
                            name="status"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none transition">
                        <option value="draft" <?php echo e(old('status', $article->status) === 'draft' ? 'selected' : ''); ?>>草稿</option>
                        <option value="published" <?php echo e(old('status', $article->status) === 'published' ? 'selected' : ''); ?>>发布</option>
                    </select>
                </div>
                ...
                <?php if($article->status === 'published'): ?>
                    <a href="<?php echo e(route('article.show', $article->slug)); ?>" target="_blank"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <dl class="text-sm space-y-2">
                    <div class="flex justify-between">
                        ...
                        <dd class="text-gray-900"><?php echo e($article->view_count); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-gray-500">创建时间</dt>
                        <dd class="text-gray-900"><?php echo e($article->created_at->format('Y-m-d H:i')); ?></dd>
                    </div>
                    <?php if($article->published_at): ?>
                        <div class="flex justify-between">
                            <dt class="text-gray-500">发布时间</dt>
                            <dd class="text-gray-900"><?php echo e($article->published_at->format('Y-m-d H:i')); ?></dd>
                        </div>
                    <?php endif; ?>
                </dl>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/articles/edit.blade.php ENDPATH**/ ?>